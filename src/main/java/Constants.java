public class Constants {
    ...
    public final static int OPENWW_X = 10;
    public final static int OPENWW_Y = 10;
    ...
    public static final int PHONE_NUM_WIDTH = 300;
    public static final int PHONE_NUM_HEIGHT = 50;

    public static final int TEXT_DATA_X = 400;
    public static final int TEXT_DATA_WIDTH = 300;
    public static final int TEXT_DATA_HEIGHT = 50;
